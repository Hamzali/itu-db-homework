...
class LecturersModel(BaseModel):
    ...
    def listAllLecturers(self):
        return self.find(self, return_cols=["fname", "sname", "id"],
                         sort_by="")
    
    def listAllLecturersBySName(self):
        return self.find(self, return_cols=["sname"], sort_by="sname")

    def showALecturer(self, data):
        return self.find(self, return_cols=["fname", "sname"], 
                         query="id = %s" % data['id'])
